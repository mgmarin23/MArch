...
public interface ThingsboardService {
    ...
    @Headers ({"Accept: text/plain", "Content-Type: application/json"})
    @POST("plugins/telemetry/DEVICE/bf185470-9da9-11ed-8d2b-073de4e14907/SHARED_SCOPE")
    Call<Void> send (@Header("X-Authorization")String token, @Body JsonObject tele);
}
